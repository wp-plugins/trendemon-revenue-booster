	...
	<legend>Basic:</legend>
		...
		<div class="show_lift">		
			...
			<span class="tooltip tooltip-effect-1">
				<span class="tooltip-item"><img src="/wp-content/plugins/trd-plugin/img/i.png"/></span>
				<span class="tooltip-content clearfix"><img src="/wp-content/plugins/trd-plugin/img/img2_anim.gif" id="img1"/></span>
			</span>
			</p>
			<p>
			...
			<span class="tooltip tooltip-effect-1">
				<span class="tooltip-item"><img src="/wp-content/plugins/trd-plugin/img/i.png"/></span>
				<span class="tooltip-content clearfix"><img src="/wp-content/plugins/trd-plugin/img/img1_anim.gif" id="img1"/></span>
			</span>
			</p>
		</div>
		...
		<table class="settings-table">        
			...
			<span class="tooltip tooltip-effect-1">
					<span class="tooltip-item"><img src="/wp-content/plugins/trd-plugin/img/i.png"/></span>
					<span class="tooltip-content clearfix"><img src="/wp-content/plugins/trd-plugin/img/img3_anim.gif" id="img1"/></span>
			</span>
			</td>
